        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GroupChats_AspNetUsers_CreatedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GroupChatMemberId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    GroupChatId = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupChatMembers", x => x.GroupChatMemberId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EndDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    TotalHoursRendered = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TotalHoursCompleted = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DailyTimeRecords", x => x.DtrId);
                    table.ForeignKey(
                        name: "FK_DailyTimeRecords_Interns_InternId",
                        column: x => x.InternId,
                        principalTable: "Interns",
                        principalColumn: "InternId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InternId = table.Column<int>(type: "int", nullable: false),
                    SupervisorId = table.Column<int>(type: "int", nullable: false),
                    TechnicalCompetence = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Punctuality = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Cooperation = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Communication = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    QualityOfWork = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DailyTimeRecords_InternId",
